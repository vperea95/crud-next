...
const AddProduct = (props) => {
  ...
  const [inputFields, setInputFields] = useState([
    { id: uuidv4(), precioName: '', cantidadName: '', totalName: '' },
  ]);
  ...
  const multi = () =>{
    const Precio = [...inputFields, { precioName }]
    const cantidad = [...inputFields, { cantidadName }]
    const multi = Precio * cantidad
    return multi
  }
              ...
              {inputFields.map(inputField => (
                <div key={inputField.id}>
                  ...
                  <Form.Control
                    ...
                    label="Total"
                    variant="filled"
                    value={inputField.totalName = multi }
                    // onChange={(e) => onChangeLitem(e)}
                    onChange={event => handleChangeInput(inputField.id, event)}
                  />
